...
# CUDA_VISIBLE_DEVICES=1 python prompt_symbolic.py --method zero-shot --num_examples 0 --model_name Llama-3.1-8B-Instruct --strategy direct_command --role teacher
# CUDA_VISIBLE_DEVICES=1 python prompt_symbolic.py --method zero-shot --num_examples 0 --model_name Llama-3.1-8B-Instruct --strategy step_by_step --role teacher
# CUDA_VISIBLE_DEVICES=1 python prompt_symbolic.py --method zero-shot --num_examples 0 --model_name Llama-3.1-8B-Instruct --strategy calc_and_explanation --role teacher
# CUDA_VISIBLE_DEVICES=1 python prompt_symbolic.py --method zero-shot --num_examples 0 --model_name Mistral-7B-Instruct-v0.3 --strategy direct_command --role teacher
# CUDA_VISIBLE_DEVICES=1 python prompt_symbolic.py --method zero-shot --num_examples 0 --model_name Mistral-7B-Instruct-v0.3 --strategy step_by_step --role teacher
# CUDA_VISIBLE_DEVICES=1 python prompt_symbolic.py --method zero-shot --num_examples 0 --model_name Mistral-7B-Instruct-v0.3 --strategy calc_and_explanation --role teacher

CUDA_VISIBLE_DEVICES=1 python prompt_symbolic.py --method cot_icl --num_examples 15 --model_name Mistral-7B-Instruct-v0.3 --strategy calc_and_explanation --role expert
CUDA_VISIBLE_DEVICES=1 python prompt_symbolic.py --method cot_icl --num_examples 8 --model_name Mistral-7B-Instruct-v0.3 --strategy calc_and_explanation --role expert
CUDA_VISIBLE_DEVICES=1 python prompt_symbolic.py --method cot_icl --num_examples 5 --model_name Mistral-7B-Instruct-v0.3 --strategy calc_and_explanation --role expert


CUDA_VISIBLE_DEVICES=4 python prompt_symbolic.py --method cot_icl --num_examples 5 --model_name Mistral-7B-Instruct-v0.3 --strategy calc_and_explanation --role expert
